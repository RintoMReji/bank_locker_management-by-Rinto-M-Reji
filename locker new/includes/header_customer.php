...
<aside class="sidebar sidebar-customer">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="<?= $base ?>/customer/access_locker.php" <?= (basename($_SERVER['PHP_SELF'])=='access_locker.php')?'class="active"':'' ?>>
      <span class="icon">🔐</span> Access Locker
    </a>
    ...
    <a href="<?= $base ?>/customer/delete_request.php" <?= (basename($_SERVER['PHP_SELF'])=='delete_request.php')?'class="active"':'' ?>>
      <span class="icon">🗑️</span> Request Delete Locker
    </a>
