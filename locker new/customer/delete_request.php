<?php
$page_title = "Request Delete Locker";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$alloc) { $err = "Invalid allocation."; }
        ...
        if ($exists) { $err = "A delete request is already pending for this locker."; }
            ...
            $stmt->execute();
            $msg = "Delete request submitted successfully! The bank will review your request.";
        }
    }
}
...
<div class="card mb-20">
  <div class="card-header"><h3>🗑️ Request Locker Deletion</h3></div>
  <div class="card-body">
    ...
    <form method="POST">
      ...
      <button type="submit" class="btn btn-danger" onclick="return confirm('Submit delete request?')">🗑️ Submit Request</button>
    </form>
  </div>
</div>
<?php endif; ?>
...
<div class="card">
  <div class="card-header"><h3>📋 My Delete Requests</h3></div>
  <div class="table-responsive">
    <table>
      ...
      <tbody>
        ...
        <tr><td colspan="7" class="text-center" style="padding:30px;color:#888;">No delete requests.</td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
