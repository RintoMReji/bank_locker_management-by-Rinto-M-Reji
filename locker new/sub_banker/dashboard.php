...
<div class="card">
  ...
  <div class="table-responsive">
    <table>
      <thead><tr><th>Alloc No.</th><th>Customer</th><th>Locker</th><th>Date</th><th>Expiry</th><th>Status</th><th>Approval</th></tr></thead>
      <tbody>
        ...
        <tr>
          ...
          <td><?= getGuideApprovalBadge($row['guide_approval'] ?? 'approved') ?></td>
        </tr>
        <?php endwhile; ?>
      </tbody>
    </table>
