...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'approve') {
        ...
        if ($req) {
            ...
            $conn->commit();
            $msg = "Delete request approved. Locker has been surrendered.";
            logActivity($conn, 'admin', $_SESSION['admin_id'], $_SESSION['admin_name'], "Approved delete request #$req_id");
        }
        ...
        logActivity($conn, 'admin', $_SESSION['admin_id'], $_SESSION['admin_name'], "Rejected delete request #$req_id");
    }
}
  ...
  <div class="card-body">
    ...
    <div class="approval-card">
      ...
      <form method="POST" class="approval-actions">
        ...
        <button type="submit" name="action" value="approve" class="btn btn-success" onclick="return confirm('Approve this delete request?')">✅ Approve</button>
    ...
    <?php endwhile; ?>
    <?php if(!$found): ?>
    <div class="text-center" style="padding:40px;color:#888;">No delete requests found.</div>
    <?php endif; ?>
  </div>
</div>
