...
// Get guide approval badge (with animation for pending)
function getGuideApprovalBadge($status) {
    $badges = [
...
function getDashboardStats($conn) {
    ...
    $stats['pending_approvals'] = $conn->query("SELECT COUNT(*) as c FROM allocations WHERE guide_approval='pending'")->fetch_assoc()['c'];
